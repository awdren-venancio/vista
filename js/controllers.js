...
function sparklineChartCtrl() {
    ...
    var smallPieOptions = {
        type: 'pie',
        sliceColors: ['#1c84c6', '#b3b3b3', '#e4f0fb']
    };
...
function GoogleMaps($scope) {
    ...
    $scope.mapOptions4 = {
        ...
        center: new google.maps.LatLng(40.6700, -73.9400),
        // Style for Google Maps
        styles: [{ "stylers": [{ "hue": "#1a7bb9" }, { "visibility": "on" }, { "invert_lightness": true }, { "saturation": 40 }, { "lightness": 10 }] }],
        mapTypeId: google.maps.MapTypeId.ROADMAP
    };
}
